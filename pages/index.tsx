      ...
      <main className="container mx-auto px-4 py-8">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="bg-white rounded-xl shadow-md mb-6 overflow-hidden">
            <div className="flex flex-wrap">
              {tabs.map((tab, idx) => (
                <button
                  key={idx}
                  className={`flex items-center py-3 px-4 font-jua text-sm sm:text-base transition-all duration-300 ${
                    activeTab === idx 
          ...
          <div className="card">
            ...
            {activeTab === 0 && (
              <div>
                <h2 className="text-2xl font-jua text-primary-dark mb-6 pb-2 border-b-2 border-pink-200">
                  경기 토론 수업 모형 소개
                </h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                  <div className="card text-center hover:shadow-xl transition-shadow">
                    ...
                    <h3 className="text-xl font-jua text-primary-dark mb-2">다름 드러내기</h3>
                    <p className="font-gaegu text-gray-600">서로 다른 생각과 관점을 자유롭게 표현합니다.</p>
                  </div>
                  <div className="card text-center hover:shadow-xl transition-shadow">
                    <div className="bg-pink-100 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4">
                      <span className="text-xl font-bold text-primary-dark">2</span>
                    </div>
                    <h3 className="text-xl font-jua text-primary-dark mb-2">다름 이해하기</h3>
                    <p className="font-gaegu text-gray-600">서로 다른 의견의 이유와 배경을 이해합니다.</p>
                  </div>
                  <div className="card text-center hover:shadow-xl transition-shadow">
                    <div className="bg-pink-100 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4">
                      <span className="text-xl font-bold text-primary-dark">3</span>
                    </div>
                    <h3 className="text-xl font-jua text-primary-dark mb-2">다름과 공존하기</h3>
                    <p className="font-gaegu text-gray-600">다양한 의견이 함께 존재할 수 있음을 인정합니다.</p>
                  </div>
                </div>

                <div className="bg-pink-50 rounded-lg p-6 mb-8">
                  <h3 className="text-xl font-jua text-primary-dark mb-4">경기 토론 수업 모형이란?</h3>
                  <p className="font-gaegu text-gray-700 mb-4">
                ...
                <div className="bg-white border border-pink-200 rounded-lg p-6">
                  <h3 className="text-xl font-jua text-primary-dark mb-4">토론부기를 활용하는 방법</h3>
                  <ol className="list-decimal list-inside space-y-3 font-gaegu text-gray-700">
                ...
                {topicRecommendations && (
                  <div className="prose max-w-none font-gaegu">
                    ...
                    <div className="mt-6 border-t-2 border-pink-100 pt-4">
                      <p className="font-jua text-primary-dark mb-3">마음에 드는 주제가 있나요? 선택하여 토론을 시작해보세요!</p>
                      <input
                        type="text"
                        value={debateTopic}
                        onChange={(e) => setDebateTopic(e.target.value)}
                        placeholder="토론하고 싶은 주제를 직접 입력하거나 위에서 선택하세요"
                        className="w-full px-4 py-3 border-2 border-pink-200 rounded-lg focus:ring-primary focus:border-primary font-gaegu text-lg mb-4"
                      />
                      <button
            ...
            {activeTab === 2 && (
              <div>
                ...
                {debateSections.length > 0 && (
                  <div className="mb-8">
                    <h3 className="text-2xl font-jua text-primary-dark mb-6 border-b-2 border-pink-200 pb-2">토론 결과</h3>
                ...
                {debateHistory.length > 0 && (
                  <div>
                    <h3 className="text-xl font-jua text-primary-dark mb-4 border-b-2 border-pink-200 pb-2">최근 토론 주제</h3>
            ...
            {activeTab === 3 && (
              <div>
                ...
                <form onSubmit={handleGenerateArguments} className="space-y-4 mb-8">
                  <div>
                    <label htmlFor="argumentTopic" className="block text-lg font-jua text-gray-700 mb-2">
                      토론 주제
                    </label>
                    <input
                      type="text"
            ...
            {activeTab === 4 && (
              <div>
                ...
                <form onSubmit={handleProvideFeedback} className="space-y-4 mb-8">
                  <div>
                    <label htmlFor="feedbackTopic" className="block text-lg font-jua text-gray-700 mb-2">
                      토론 주제
                    </label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label htmlFor="studentArgument" className="block text-lg font-jua text-gray-700 mb-2">
                      나의 의견
                    </label>
                    <textarea
                      id="studentArgument"
                ...
                {feedbackResult && (
                  <div className="prose max-w-none font-gaegu bg-pink-50 p-6 rounded-lg">
